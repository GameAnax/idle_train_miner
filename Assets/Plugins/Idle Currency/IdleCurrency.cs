...
/// Modified for use by GameAnax team
/// </summary>
...
public struct IdleCurrency
{
    ...
    public static IdleCurrency Zero
    {
        get
        {
            return new IdleCurrency(0, 0);
        }
    }
    ...
    public void UpdateFormatStringValue()
    {
        toStringValue = ToShortString();
    }

    public string ToShortString(string format = "#.##")
    {
        return ToShortString(false, format);
    }
    ...
    public string ToShortStringIntRound(bool isForceDecimal = false, string format = "#.##")
    {
        string[] PremitiveAlphapets = { "K", "M", "B", "T" };
        string[] FutureAlphapets = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z" };
    ...
    public string ToShortStringIntRoundForBizCash(string format = "#.##")
    {
        string[] PremitiveAlphapets = { "K", "M", "B", "T" };
        string[] FutureAlphapets = { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z" };
    ...
    {
        // string data = AppStatic.PersistentPrefsWrapper.GetString(key, string.Empty);
        string data = "";
    ...
    //         value.Value = 0;
    //     }
    //     // AppStatic.PersistentPrefsWrapper.SetString(key, value.Value.ToString() + "-" + value.Exp.ToString());
    // }
